...
namespace Chapter1_1_2 {
    ...
    internal class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine("X: {0}, Y: {1}", wMyClass1.X, wMyClass1.Y);
            Console.WriteLine("X: {0}, Y: {1}", wMyStruct1.X, wMyStruct1.Y);
        }
        ...
        static void PrintObjects(MyClass vMyClass, MyStruct vMyStruct) {
            // MyClass の内容を表示
            Console.WriteLine("X: {0}, Y: {1}", vMyClass.X, vMyClass.Y);

            // MyStruct の内容を表示
            Console.WriteLine("X: {0}, Y: {1}", vMyStruct.X, vMyStruct.Y);
        }
